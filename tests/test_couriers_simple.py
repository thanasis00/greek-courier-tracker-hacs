...
class TestAutoDetection:
    ...
    def test_detect_geniki_10_digits(self):
        """Test that 10 digits are detected as geniki."""
        # Geniki also matches 10 digits and is checked before ACS
        assert detect_courier("1234567890") == "geniki"
